...
export default {
  ...
  '新项目默认放在 NoDesign 自己的目录里。想放进你的文件夹，或打开一个已有仓库：': 'New projects live in NoDesign\'s own data folder by default. To keep one in your own folder, or open an existing repo:',
  '选一个文件夹': 'Choose a folder',
  '空文件夹从零开始；已有仓库先读一遍再动': 'An empty folder starts from scratch; an existing repo gets read first',
  '先看看这个仓库：它是什么、怎么跑起来、结构和入口、我上次干到哪。写成板书，最后问我从哪改起。': 'Start by reading this repo: what it is, how to run it, its structure and entry points, and where I left off. Write it up on the board, then ask me where to begin.',
  '创建中…': 'Creating…',
  '发送（Enter）': 'Send (Enter)',
  '开 工 中': 'Starting…',
  '开 工': 'Start',
