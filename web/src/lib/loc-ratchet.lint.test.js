...
const GRANDFATHERED = {
  ...
  // 09-01 刀 2 撤掉版式底稿层（SlotLayer 整份删）：2025 → 2017
  'web/src/components/canvas/BoardCanvas.jsx': 2017,
  ...
  // 09-01 叠纸加第四张注册表时棘轮拦下，四块几乎逐字相同的合并语义收成 patchRegistry：583 → 581
  'server/projects/board-store.js': 581,
