 ...
 * 免费轮次闸）。当时算过：一轮 ≈ $0.0023，basic 的 $10/天 ≈ 4000 轮（09-08 前是 $5）。）
 */
...
export const FALLBACK_MODELS = [
  ...
  { id: DEFAULT_MODEL_ID, label: 'GLM-5.3-Flash · 设计', desc: '支持视觉 · 单次最多 8 张图片（更早的自动省略）· 1M 上下文 · 成本极低', brand: DEFAULT_BRAND },
