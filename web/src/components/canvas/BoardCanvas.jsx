...
export default function BoardCanvas({
   ...
   */
  // 「哪一层装了什么」（桌面和文件夹窗共用）→ board-dir-index.js
  const dirIndex = useDirIndex({ objects, zonesEff, layout });
  ...
  const liveChalkSpotFor = useLiveChalkSpots({ sheets, layout, camera, scrollRef, stacks });
