...
const BOARD = {
  size: { w: 4000, h: 2600 },
  // 纸（2026-08-29 纸范式）：SheetLayer 的渲染回归靠它
  sheets: {
     ...
     */
    s1: { x: 2600, y: 240, w: 1200, h: 900, colW: 432, by: 'agent', at: '2026-09-01T01:00:00Z', title: '叠·第一页', stack: 'demo' },
    s2: { x: 2600, y: 240, w: 1200, h: 900, colW: 432, by: 'agent', at: '2026-09-01T02:00:00Z', title: '叠·第二页', stack: 'demo' },
    /**
     * 正序的一摞（2026-09-01 刀 2）：`order:'asc'` 的意思是「读的人停在第一页，
     * 自己往后翻」。这件事**单测照不出来** —— 单测比的是 displayedPage 的返回值，
     * 而真正要证的是屏幕上画的是哪一页。摆在 demo 那一摞下面。
     */
    a1: { x: 2600, y: 1200, w: 1200, h: 900, colW: 432, by: 'agent', at: '2026-09-01T03:00:00Z', title: '正序·第一页', stack: 'doc' },
    a2: { x: 2600, y: 1200, w: 1200, h: 900, colW: 432, by: 'agent', at: '2026-09-01T04:00:00Z', title: '正序·第二页', stack: 'doc' },
  },
  /** 摞的登记：身份 + 正倒序 */
  stacks: {
    demo: { title: '叠起来的一摞', at: '2026-09-01T01:00:00Z' },
    doc: { title: '一份文档', at: '2026-09-01T03:00:00Z', order: 'asc' },
  },
  ...
  objects: {
    ...
    // 正序那一摞：屏幕上只该看得见 a1 那件（跟 demo 正好反过来）
    'text:ascA': {
      x: 2640, y: 1260, w: 200, h: 40, z: 3,
      kind: 'text', data: { t: '正序第一页的字', font: 'kai', size: 'md', color: 'ink' }, sheet: 'a1',
    },
    'text:ascB': {
      x: 2640, y: 1340, w: 200, h: 40, z: 4,
      kind: 'text', data: { t: '正序第二页的字', font: 'kai', size: 'md', color: 'ink' }, sheet: 'a2',
    },
    'text:beat': {
