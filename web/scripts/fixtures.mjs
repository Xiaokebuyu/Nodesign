...
const BOARD = {
  ...
  /**
   * 摞的登记：身份 + **这一摞的版式**（2026-09-01 册）。s1/s2 都不带自己的 slots，
   * 所以两页都继承这两块地 —— 检查通道里要看得见 SlotLayer 真把它画出来。
   */
  stacks: {
    demo: {
      title: '叠起来的一摞', at: '2026-09-01T01:00:00Z',
      slots: {
        main: { x: 0, y: 0, w: 700, h: 500, about: '正文' },
        aside: { x: 730, y: 0, w: 400, h: 500, about: '边栏' },
      },
    },
  },
