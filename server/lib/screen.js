...
/**
 * 一张卡的高度参考值（2026-08-29 占位契约刀 B，站主定「一张纸的 40%」）。
 *
 * ⚠️ 09-18 起板书不再封顶：站主定折叠整个去掉（「折叠有点难看」），板书按真高存、真高铺开，
 * 长了占的地方由话题整组让开消化（lib/topic-settle.js）。这个值还在用的地方：flow 拆条的每段上限、
 * 文件卡预览的裁切。下面是它当年作为天花板的来历。
 *
 *
