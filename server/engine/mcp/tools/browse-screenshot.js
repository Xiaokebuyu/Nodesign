...
the workspace for the user.`,
    {
      ...
      scrollBy: z.number().min(-8000).max(8000).optional()
        .describe('FILMSTRIP: pixels of real wheel scrolling dispatched over the recording window (positive = down; -8000 to 8000, values outside run at the nearest limit). The natural way to record scroll-driven motion on a site you did not write.'),
