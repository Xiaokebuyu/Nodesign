...
export async function buildEnv(rt, model, owner) {
  ...
  const env = { ...agentInheritedEnv(), ...AGENT_CLI_POLICY_ENV, PWD: rt.wsRoot, CLAUDE_AGENT_SDK_CLIENT_APP: 'nodesign-stage/0.0.1', CLAUDE_CONFIG_DIR: platform.claudeConfigDir };
