...
import { clearProject as clearRoleInboxes } from './inbox.js'; import { clearScene } from './scene.js'; import { clearStage } from './stage-broadcast.js';
...
export async function runSession({
  ...
  try {
    ...
    clearRoleInboxes(projectId); clearScene(projectId); clearStage(projectId);   // 收件箱放掉 waiter + 场散 + 广播链深清（跟角色同寿命）
