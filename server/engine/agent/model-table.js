...
export const MODELS_BUILTIN = Object.freeze([
  ...
  {
    // 09-08 晚站主接的 DeepSeek 官方直连行；09-10 连 id 带 wireModel 一起换成官方现在的名字（旧的预览名今天到期、
    // 已不在目录里；旧 id 在 model-renames.js 留着）。⚠️ 价沿用 09-08 那份没重核。按量计额度；1M 窗口走共用别名。
    id: 'deepseek-flash', window: 1_000_000, brand: 'deepseek',
