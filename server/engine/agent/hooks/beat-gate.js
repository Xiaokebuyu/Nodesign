...
export const BEAT_HANGING_REASON =
  '这一拍还停在半空：你往画布上写了东西，但既没给玩家一个可按的下一步，'
  + '也没把这一拍交给任何角色。二选一再收工 ——\n'
  + '① 这一拍该轮到某个人说话：`SendMessage` 把用户的原话和场上的变化寄给它'
  + '（第一次上场用 `Agent`，subagent_type 写 "rp-role"）；\n'
  + '② 这一拍到此为止、等玩家决定：在这一拍下面补一条 ```nd:controls``` 围栏，'
  + '两到四枚选项（一枚推进主线、一枚人际、一枚意想不到），再留一句「想干别的直接在画布上标注」。\n'
