...
const MODE_ALWAYS = [
  ...
  // ⛔ 版位那一族的锚（「开工先规划整版」「自己定几个空位」「一张纸规划一次」
  // 「有规划的自由」「那是兜底不是版面」和 plan 的示例）09-01 刀 2 随版位一起退役。
  '版面归机器，内容归你',     // 09-01 刀 2：不给位置就直接写，机器按栏排
  '写多长都行，机器会替你切段', // 09-01 刀 2：超过一张卡按段落边界自动拆链
  '给产物配一张说明纸',       // 09-01 刀 2：摆放升到纸张级（open_sheet{near}）
  '一摞 = 一件事',            // 09-01 刀 2：一直要看得见的东西给它自己一摞
