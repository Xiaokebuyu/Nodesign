...
export const DENIAL = Object.freeze({
  imageGen: '当前账号所在档位不包含图像生成。原话转告用户，不要重试、不要换别的生图工具。',
  imageQuota: '今日额度已用完（图像生成按 $0.20/张计入每日额度），明天零点重置。原话转告用户，这轮别再生图。',
  localGenTier: '当前账号所在档位不包含本地产线（图像/视频生成）。原话转告用户，不要重试。',
  localGenApproval: '本地产线需单独开通，该账号尚未开通。原话转告用户，不要重试。',
  publishSite: '当前账号所在档位不包含将站点发布到公网',
  subscription: '仅限 Pro 档，当前不对外开放',
});
